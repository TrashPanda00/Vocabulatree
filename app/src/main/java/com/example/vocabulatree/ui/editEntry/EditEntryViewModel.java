...
public class EditEntryViewModel extends AndroidViewModel {
    ...
    public void update(String word, String language, String translation, String dateAdded, String masteryLevel, String forvoLocation, String personalLocation, Integer id) {repository.update(word, language, translation, dateAdded, masteryLevel, forvoLocation, personalLocation, id);}
}