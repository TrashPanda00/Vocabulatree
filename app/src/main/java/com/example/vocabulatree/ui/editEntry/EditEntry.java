	...
	if (getArguments() != null)
	{
		...
		saveButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				viewModel.update(toAdd.getWord(), toEdit.getLanguage(), toAdd.getTranslation(), toAdd.getDateAdded(), toEdit.getMasteryLevel(), toEdit.getForvoLocation(), toEdit.getPersonalLocation(), toEdit.getId());
			}
		});
